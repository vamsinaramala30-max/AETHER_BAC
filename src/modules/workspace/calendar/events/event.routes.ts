...
export function createEventRouter(controller: EventController): Router {
  ...
  router.post('/', validateEventPayload(CreateEventSchema), (req, res, next) =>
    controller.create(req, res, next),
  );
  router.patch('/:id', validateEventPayload(UpdateEventSchema), (req, res, next) =>
    controller.update(req, res, next),
  );
  router.delete('/:id', (req, res, next) => controller.delete(req, res, next));
  router.post('/:id/respond', validateEventPayload(RespondInvitationSchema), (req, res, next) =>
