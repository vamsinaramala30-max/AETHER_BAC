...
export const runAgentSchema: ToolInputSchema = {
  ...
  properties: {
    ...
    goal: { type: 'string', description: 'Goal or prompt for agent execution', minLength: 1, maxLength: 8192 },
    conversationId: { type: 'string', description: 'Optional conversation scope' },
    maxIterations: { type: 'integer', description: 'Maximum allowed loop iterations', minimum: 1, maximum: 50 },
  },
