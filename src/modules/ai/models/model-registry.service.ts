    ...
    const defaults: ModelEntity[] = [
      {
        ...
        capabilities: { streaming: true, toolCalling: true, vision: true, embeddings: false, maxContextTokens: 128000 },
        isActive: true,
        createdAt: new Date(),
      },
      {
        ...
        costPer1kCompletionTokens: 0.015,
        capabilities: { streaming: true, toolCalling: true, vision: true, embeddings: false, maxContextTokens: 200000 },
        isActive: true,
        createdAt: new Date(),
      },
      {
        ...
        capabilities: { streaming: true, toolCalling: true, vision: true, embeddings: false, maxContextTokens: 1000000 },
        isActive: true,
        createdAt: new Date(),
      },
    ];
